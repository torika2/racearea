    ...
    <style type="text/css">
        ...
        <div class="sidebar">
                ...
                <ul class="top-channels" style="margin-left: -10px;">
                    @foreach (App\Channel::select('users.id AS uId','channels.id as chanId','channels.twitchname','channels.choosen_game')->join('users','channels.userId','=','users.id')->orderBy('channels.view','desc')->take(5)->get() as $popularUsers)
...
<a href="{{ route('home') }}" class="logoLink">
  <img src="{{ asset('Images/gamepad.png') }}" width="60px;" style="margin-top: 0%;" alt="logo" >
</a>
        </div>
